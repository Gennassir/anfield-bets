...
export const teams: Team[] = [
  { id: "ars", name: "Arsenal", short: "ARS", color: "0 85% 55%", odds: 10 },
  { id: "mci", name: "Manchester City", short: "MCI", color: "200 85% 55%", odds: 7 },
  { id: "liv", name: "Liverpool", short: "LIV", color: "0 90% 45%", odds: 17 },
  { id: "che", name: "Chelsea", short: "CHE", color: "220 85% 50%", odds: 50 },
